    ...
    >
      <div className="flex flex-col items-center justify-center gap-4 px-6 py-8 text-center backdrop-blur-0 lg:my-12 lg:flex-row-reverse lg:text-left">
        ...
        <div className="basis-1/2 space-y-8">
          <h1 className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-4xl font-bold tracking-widest text-transparent lg:text-6xl dark:from-violet-600 dark:to-white">
          ...
          <p className="text-balance text-lg md:text-xl">
            ...
            . A dedicated Full Stack Web developer based in Quezon City,
            Philippines. 📍
          </p>
          <div className="flex items-center justify-center gap-x-6 text-lg lg:justify-start">
            <SocialIcon
            ...
            <SocialIcon
              ...
              label="Website"
              icon={<IconWorldWww className="h-8 w-8" />}
            />
          </div>
        </div>
      </div>
