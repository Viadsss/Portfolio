  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center gap-4 px-6 py-8 text-center backdrop-blur-0 lg:my-12 lg:flex-row-reverse lg:text-left">
        <div className="animate-morph my-8 aspect-square w-full max-w-80 basis-1/2 border-4 border-blue-800 bg-[url('/Me.jpg')] bg-cover bg-center dark:border-violet-800"></div>
        <div className="basis-1/2 space-y-8">
          ...
          <div className="flex items-center justify-center gap-x-6 text-xl lg:justify-start">
            <a
              className="transition hover:-translate-y-1 hover:text-violet-400"
              href=""
              target="_blank"
